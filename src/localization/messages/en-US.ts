...
const en_US: Messages = {
  ...
  'onboarding.selectLanguageSubtitle': 'Please select your language for Seguro Platform. ' + 'You will be able to change this later in settings.',
  ...
  'onboarding.verificationText': 'Please enter the invitation code you have received to begin the verification process.',
  ...
  'platform.network.status.description.low':
    'Your connection to Seguro appears to have high latency. Please check your internet connection is stable. Data may drop more than usual.',
  'platform.network.status.description.medium':
    'Your connection to Seguro has medium latency. Your data might be occasionally dropped or have trouble sending, please check your internet connection.',
  ...
  'platform.ProfileDropdown.conet_si.nodes.detail':
    'The nodes of CoNET-SI are composed of CoNET-SI miners distributed around the world. They provide network equipment to users to obtain the anonymous US dollar stablecoin CoNETCash paid by users as income. Users can purchase cloud computing storage and network service.',
  'platform.ProfileDropdown.conet_si.nodes.mining':
    'CoNET-SI welcomes anyone who provides redundant computer equipment to mine as a participant to earn encrypted stable currency returns based on US dollars. Please visit the CoNET project website for more detailed information',
  ...
  'platform.ProfileDropdown.nodelist.registersPayment.authorizationInformation':
    'This only verifies your CoNETCash is valid and that there are enough funds available in your CoNETCash. The transaction will be marked as "Hold" in CoNETCash History. The funds on the CoNETCash will be placed on hold (pending transaction). The authorized party has the right to deduct the service or product you purchased from your authorized amount.',
  'platform.ProfileDropdown.nodelist.registersPayment.registersfinished1':
    'Registration is complete, others can communicate via Seguro Messagure with you through the address: ',
  'platform.ProfileDropdown.nodelist.registersPayment.registersfinished2':
    ' and you can also deploy your anonymous server in the CONET-SI network through this address.',
  ...
  'platform.ProfileDropdown.nodelist.entryNodeditail':
    'The CoNET-SI entry node is a bridge for user equipment to connect to the CoNET-SI network through the Internet without IP addresses.',
  ...
  'platform.ProfileDropdown.nodelist.about1':
    'The data packets transmitted on the Internet contain the IP addresses and unencrypted content of the sender and the recipient.',
  ...
  'platform.app.seguro.messenger.panels.addContact.firstMessage':
    'Additionally, you may set a nickname for this contact. Send them a custom greeting to let them know who you are!',
  ...
  'launchPage.HeaderArea.secondPart.1':
    'CoNET has reinvented the Internet by coming up with a censorship-resistant method of data  exchange using wallet addresses instead of IP addresses.',
  ...
  'launchPage.FeatureArea1.2':
    'The CONET blockchain represents a brand new network layer for the Internet that does not use IP addresses or contain any metadata. This is the only routing method that enables total anonymity, privacy, and universal access.',
  'launchPage.FeatureArea2.1': 'EASY FOR USERS TO UNDERSTAND AND USE',
  'launchPage.FeatureArea2.2':
  ...
  'launchPage.FeatureArea3.2':
    'On the CoNET blockchain, users are able to pay gas, earn rewards, delegate tokens, run nodes, and vote on governance initiatives with the CoNET token. The quality of service is decided by users and service providers themselves, and CoNET is no longer involved.',
  ...
  'launchPage.FeatureArea5.2':
    'Privacy from government and corporate surveillance is becoming increasingly important to users. By replacing cumbersome Web2 communication protocols with an innovative Web3 protocol, true privacy becomes possible.',
  ...
  'platform.proxy.featureArea8Item.reload': 'reload',
  ...
  'platform.joinUS.forUser.detail':
    'User-driven validation model eliminates the need for centralized intermediaries, enhancing security and trust in the ecosystem',
  ...
  'platform.miner.community.liveness.chainDelayInfo':
    'With the busy transactions on CONET Holesky blockchain, the CNTP you receive may be delayed by approximately 30 minutes.',
  ...
  'platform.miner.cloudnode.orderForm.detail':
    'The CONET Layer Minus network backbone nodes provide high-throughput network data forwarding for CONET users, ensuring uninterrupted exclusive rewards in CNTP cloud node incentives.',
